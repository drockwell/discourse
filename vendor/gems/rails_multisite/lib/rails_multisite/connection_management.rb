module RailsMultisite
  class ConnectionManagement
    ...
    def self.current_hostname
      ActiveRecord::Base.connection_pool.spec.config[:host_names].first if Rails.env == "development"
      ActiveRecord::Base.connection_pool.spec.config[:host] if Rails.env == "production"
    end
